...
INSERT INTO caracteristique (id_caracteristique, nom, code, description, type) VALUES
    (1, 'Intelligence', 'INT', 'Permet de résoudre des énigmes, de réaliser des expériences scientifiques, de construire des raisonnements logiques…', 'Principale'),
    (2, 'Réflexes', 'RÉF', 'Sert à combattre, esquiver et effectuer des actions nécessitant des réactions rapides et des gestes précis.', 'Principale'),
    (3, 'Dextérité', 'DEX', 'Pour les attaques à distance et tout ce qui implique de faire appel à l''équilibre et à la coordination œil-main.', 'Principale'),
    (4, 'Corps', 'COR', 'S''utilise lorsqu''il faut faire appel à la force brute, comme pour les bagarres ou les prouesses physiques. Le corps représente aussi l''endurance nécessaire pour résister aux maladies ou à la fatigue.', 'Principale'),
    (5, 'Vitesse', 'VIT', 'Représente la vitesse de déplacement de votre personnage. Vous pouvez utiliser cette caractéristique pour semer les poursuivants ou calculer la distance parcourue dans un temps donné.', 'Principale'),
    (6, 'Empathie', 'EMP', 'Pour gérer les affaires de cœur et les émotions. La séduction et la persuasion font appel à cette caractéristique.', 'Principale'),
    (7, 'Technique', 'TECH', 'Pour utiliser des mécanismes ou créer des objets avec précision. La technique sert également à manier des machines de siège et à installer des pièges.', 'Principale'),
    (8, 'Volonté', 'VOL', 'Sert à intimider, mais aussi à réaliser des tests magiques et de résistance mentale. La volonté dénote votre capacité à aller de l''avant et votre degré de maîtrise de la magie.', 'Principale'),
    ...
    (10, 'Vigueur', 'VIG', 'Votre valeur de Vigueur correspond au nombre de points de Chaos que vous pouvez canaliser sans vous blesser. Vous subissez des dégâts lorsque le coût d''endurance de tous les sorts que vous lancez pendant un round est supérieur à cette valeur.', 'Autre'),
    ...
    (12, 'Course', 'COU', 'Cette valeur correspond à votre vitesse quand vous courez à une allure raisonnable. En un tour, vous pouvez parcourir un nombre de mètres égal à votre valeur de course.', 'Secondaire'),
    (13, 'Saut', 'SAUT', 'La valeur de Saut correspond au nombre de mètres que vous parcourez en sautant après avoir pris de l''élan.', 'Secondaire'),
    (14, 'Points de santé', 'PS', 'La santé correspond au nombre de points de dégâts que vous pouvez subir avant de passer en état de mort imminente et de succomber à une hémorragie.', 'Secondaire'),
    ...
    (17, 'Récupération', 'RÉC', 'La récupération indique le nombre de points de santé que vous regagnez par jour de repos au calme dans un lit. Pour retrouver ces points de santé, quelqu’un doit d''abord réussir un jet de premiers soins ou de mains thérapeutiques sur vous.', 'Secondaire'),
    (18, 'Pieds', 'Pieds', 'Cette caractéristique indique le nombre de dégâts non létaux que vous infligez avec un coup de poing.', 'Autre'),
    (19, 'Poings', 'Poings', 'Cette caractéristique indique le nombre de dégâts non létaux que vous infligez avec un coup de pied.', 'Autre');

-- Ajout de Compétences
INSERT INTO competence (id_competence, nom, description, exclusive, specialisation, prerequis, step, type, id_caracteristique) VALUES
    (1, 'Connaissance de la rue', 'Cette compétence ne concerne pas la géographie urbaine à proprement parler, mais plutôt le fonctionnement de cet environnement. Avec une base de 10 vous en savez suffisamment pour éviter les voyous et vous rendre dans les quartiers les plus sûrs de la ville. Avec une base de 13 vous pouvez en général déterminer quelle faction exerce son influence sur un quartier donné et expliquer la raison de cette domination. Avec une base de 16 vous pouvez récolter une quantité d’informations impressionnantes sur une zone rien qu’en l’observant, mais aussi identifier les personnalités importantes de la ville et leurs relations. Avec une base de 20 vous évaluez la situation en un clin d’œil. Vous en savez assez pour compter parmi les habitants.', 0, '', '', 1, '', 1),
    ...
    (7, 'Langue commune', 'La capacité à dispenser son savoir. Vous n’êtes pas tenu de maîtriser cette capacité pour en enseigner d’autres, mais elle vous facilitera la tâche. Avec une base de 10 vous savez expliquer du début à la fin un procédé simple à votre élève, mais sans que ce dernier saisisse à coup sûr tous les tenants et aboutissants de votre cheminement. Avec une base de 13 vous pouvez enseigner les bases d’une compétence à un élève attentif sans rencontrer de problème particulier. Avec une base de 16 si vous disposez de suffisamment de temps, vous pouvez apprendre des procédés plus complexes à vos étudiants, même s’ils ne sont guère attentifs. Avec une base de 20 vous êtes un maître pédagogue capable d’intéresser n’importe qui. Puisque vos leçons font toujours mouche du premier coup, vous avez rarement besoin de vous répéter.', 0, '', '', 2, 'Langue', 1),
    ...
    (11, 'Vigilance', 'Lorem Ipsum', 0, '', '', 1, '', 1),
    (12, 'Bagarre', 'Lorem Ipsum', 0, '', '', 1, 'Combat', 2),
    (13, 'Langue Ancienne', 'Lorem Ipsum', 0, '', '', 2, 'Langue', 1),
    (14, 'Langue Naine', 'Lorem Ipsum', 0, '', '', 2, 'Langue', 1),
    (15, 'Bâton/Lance', 'Lorem Ipsum', 0, '', '', 1, 'Combat', 2),
    (16, 'Équitation', 'Lorem Ipsum', 0, '', '', 1, 'Combat', 2),
    (17, 'Escrime', 'Lorem ispum', 0, '', '', 1, 'Combat', 2),
    (18, 'Esquive/Évasion', 'Lorem ispum', 0, '', '', 1, '', 2),
    (19, 'Lame courte', 'Lorem ispum', 0, '', '', 1, 'Combat', 2),
    (20, 'Mêlée', 'Lorem ispum', 0, '', '', 1, 'Combat', 2),
    (21, 'Navigation', 'Lorem ispum', 0, '', '', 1, '', 2),
    (22, 'Adresse', 'Lorem ispum', 0, '', '', 1, '', 3),
    (23, 'Arbalète', 'Lorem ispum', 0, '', '', 1, 'Combat', 3),
    (24, 'Archerie', 'Lorem ispum', 0, '', '', 1, 'Combat', 3),
    (25, 'Athlétisme', 'Lorem ispum', 0, '', '', 1, 'Combat', 3),
    (26, 'Furtivité', 'Lorem ispum', 0, '', '', 1, '', 3),
    (27, 'Physique', 'Lorem ispum', 0, '', '', 1, '', 4),
    (28, 'Résilience', 'Lorem ispum', 0, '', '', 1, '', 4),
    (29, 'Charisme', 'Loren Ipsum', 0, '', '', 1, '', 6),
    (30, 'Commandement', 'Loren Ipsum', 0, '', '', 1, '', 6),
    (31, 'Duperie', 'Loren Ipsum', 0, '', '', 1, '', 6),
    (32, 'Jeu', 'Loren Ipsum', 0, '', '', 1, '', 6),
    (33, 'Persuasion', 'Loren Ipsum', 0, '', '', 1, '', 6),
    (34, 'Psychologie', 'Loren Ipsum', 0, '', '', 1, '', 6),
    (35, 'Représentation', 'Loren Ipsum', 0, '', '', 1, '', 6),
    (36, 'Séduction', 'Loren Ipsum', 0, '', '', 1, '', 6),
    (37, 'Stylisme', 'Loren Ipsum', 0, '', '', 1, '', 6),
    (38, 'Alchimie', 'Lorem Ipsum', 0, '', '', 2, '', 7),
    (39, 'Artisanat', 'Lorem Ipsum', 0, '', '', 2, '', 7),
    (40, 'Contrefaçon', 'Lorem Ipsum', 0, '', '', 1, '', 7),
    (41, 'Déguisement', 'Lorem Ipsum', 0, '', '', 1, '', 7),
    (42, 'Fabrication de piège', 'Lorem Ipsum', 0, '', '', 2, '', 7),
    (43, 'Premiers soins', 'Lorem Ipsum', 0, '', '', 1, '', 7),
    (44, 'Courage', 'Lorem Ipsum', 0, '', '', 1, '', 8),
    (45, 'Envoûtement', 'Lorem Ipsum', 0, '', '', 2, '', 8),
    (46, 'Incantation', 'Lorem Ipsum', 0, '', '', 2, '', 8),
    (47, 'Intimidation', 'Lorem Ipsum', 0, '', '', 1, '', 8),
    (48, 'Résistance à la magie', 'Lorem Ipsum', 0, '', '', 2, '', 8),
    (50, 'Beau-arts', 'Lorem ipsum', 0, '', '', 1, '', 6),
    (51, 'Crochetage', 'Lorem Ipsum', 0, '', '', 1, '', 7),
    (52, 'Résistance à la contrainte', 'Lorem Ipsum', 0, '', '', 1, '', 8),
    (53, 'Rituels', 'Lorem Ipsum', 0, '', '', 2, '', 8);
...
-- Ajout du lien entre Compétence et Profession
...
INSERT INTO users (id_user, pseudo, email, password) VALUES
    (1, 'administrateur', 'admin@demo.com', '$2a$10$lJuSc5EoaqzFJR9wqPigtu6/wW3fqWSX9T0G6ih8tV09MGPbuxwdK'),
    (2, 'utilisateur', 'user@demo.com', '$2a$10$lJuSc5EoaqzFJR9wqPigtu6/wW3fqWSX9T0G6ih8tV09MGPbuxwdK');
